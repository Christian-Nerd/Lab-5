/*
**  Name: Trey Davis & BJ Streller
**  
**  Filename: cs121Lab5_driver.cpp 
**
**  Purpose: This program will take a file. It will They will then count the number of words in the file, and
**
**  Date Created 10/12/23
**
**  Date Last Modified 10/17/23
**
**
*/
...
|| whsp == ',' || whsp == '?' || whsp == '.' || whsp == '!' || whsp == ':' || whsp == ';' || whsp == '(' || whsp == ')'  /*YOU WILL NEED TO ADD OTHER CHARS HERE*/ )
